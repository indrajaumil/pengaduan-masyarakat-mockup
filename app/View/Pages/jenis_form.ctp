        ...
        <form class="form-horizontal" method="post">
            <fieldset>
                <div class="control-group">
                    <label class="control-label" for="kode_jenis_pengaduan">Kode Jenis Pengaduan</label>
                    <div class="controls">
                        <input class="input-small focused" id="kode_jenis_pengaduan" name="kode_jenis_pengaduan" type="text" value="<?php echo !empty($data['RefJenisPengaduan'])?$data['RefJenisPengaduan']['kode_jenis_pengaduan']:'';?>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="jenis_pengaduan">Nama Jenis Pengaduan</label>
                    <div class="controls">
                        <input class="input-medium" id="jenis_pengaduan" name="jenis_pengaduan" type="text" value="<?php echo !empty($data['RefJenisPengaduan'])?$data['RefJenisPengaduan']['jenis_pengaduan']:'';?>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">Simpan Data</button>
                    <a href="<?php echo $baseUrl;?>/jenisList" class="btn">Kembali</a>
                </div>
            </fieldset>
        </form>
    </div>
