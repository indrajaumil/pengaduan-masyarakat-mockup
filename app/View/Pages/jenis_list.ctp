...
<div class="row-fluid">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">Referensi Jenis Pengaduan</div>
            <a href="jenisForm/id:new" class="btn-primary pull-right btn"><i class="icon-plus icon-white"></i> Tambah Jenis Pengaduan</a>
        </div>
            ...
            <div class="span12">
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            <td class="center"><?php echo $r['RefJenisPengaduan']['kode_jenis_pengaduan'];?></td>
                            <td class="center"><?php echo $r['RefJenisPengaduan']['jenis_pengaduan'];?></td>
                            <td class="center">
                                <a href="jenisForm/id:<?php echo $r['RefJenisPengaduan']['kode_jenis_pengaduan'];?>" class="btn-primary btn"><i class="icon-pencil icon-white"></i> Ubah</a>
                                <a href="jenisDelete/id:<?php echo $r['RefJenisPengaduan']['kode_jenis_pengaduan'];?>" class="btn-danger btn"><i class="icon-trash icon-white"></i> Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                        <?php else:?>
